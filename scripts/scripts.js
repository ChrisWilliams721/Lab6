...
function changeModel() {
    let modelTextElemet = document.getElementById("model-text");

    if (modelName === "XYZ") {
        modelName = "CPRG"; modelTextElemet.innerHTML = "Model CPRG";
    } else if (modelName === "CPRG") {
        modelName = "XYZ"; modelTextElemet.innerHTML = "Model XYZ";
    }
    recalculate();
}
